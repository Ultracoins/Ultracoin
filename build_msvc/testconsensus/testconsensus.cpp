...
// ultracoin includes.
#include <..\src\script\ultracoinconsensus.h>
...
int main()
{
    std::cout << "ultracoinconsensus version: " << ultracoinconsensus_version() << std::endl;
    ...
    auto op0Result = ultracoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, ultracoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
