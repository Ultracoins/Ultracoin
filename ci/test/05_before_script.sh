...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Ultracoin
else
  DOCKER_EXEC echo \> \$HOME/.ultracoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/ultracoin/ultracoin/pull/18288#discussion_r433189350 for
  # details.
