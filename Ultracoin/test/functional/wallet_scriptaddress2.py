...
#
# Test new Ultracoin multisig prefix functionality.
#
...
class ScriptAddress2Test(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(multisig_addr[0], 'M')
        ...
        priv_keys = ["cU7eeLPKzXeKMeZvnEJhvZZ3tLqVF3XGeo1BbM8dnbmV7pP3Mg89",
        ...
        assert_equal(multisig_addr_new, 'MZ974ZrPrmqMmm1PSVp4m8YEgo3bCMZBbe')
        multisig_addr_old = "2N5nLwYz9qfnGdaFLpPn3gS6oYMbmLTWPjq"
