...
bech32_templates = [
  ...
  ('utcn',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('utcn',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('utcn',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tutcn',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tutcn',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tutcn',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rutcn',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rutcn',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rutcn', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tutcn',  17, 32, False, False, False),
  ('rutcn',  3,  1, False, False, False),
  ('utcn',   15, 41, False, False, False),
  ('tutcn',  0, 16, False, False, False),
  ('rutcn',  0, 32, True,  False, False),
  ('utcn',   0, 16, True,  False, False),
  ('tutcn',  0, 32, False, True,  False),
  ('rutcn',  0, 20, False, False, True)
]
