 ...
 */
static const char* BITCOIN_PID_FILENAME = "ultracoind.pid";
...
void Shutdown(InitInterfaces& interfaces)
{
    ...
    RenameThread("ultracoin-shutoff");
...
std::string LicenseInfo()
{
    ...
    const std::string URL_WEBSITE = "<https://buyultracoin.com>";
...
static void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("ultracoin-loadblk");
