...
([`valgrind.supp`](https://github.com/ultracoin-project/ultracoin/blob/master/contrib/valgrind.supp))
...
- ThreadSocketHandler : Sends/Receives data from peers on port 43048.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 43047 for connections and services them.
