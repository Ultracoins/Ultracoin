...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, UltracoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &UltracoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &UltracoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &UltracoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &UltracoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &UltracoinGUI::updateWalletStatus);
    connect(gui, &UltracoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
