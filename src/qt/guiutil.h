...
#ifndef ULTRACOIN_QT_GUIUTIL_H
#define ULTRACOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Ultracoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "ultracoin:" URI into recipient object, return true on successful parsing
