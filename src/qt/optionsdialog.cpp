    ...
    mapper(nullptr)
{
    ...
    ui->ultracoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->ultracoinAtStartup);
    ...
    ui->ultracoinAtStartup->setToolTip(ui->ultracoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->ultracoinAtStartup->setText(ui->ultracoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openUltracoinConfButton->setToolTip(ui->openUltracoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new UltracoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->ultracoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openUltracoinConfButton_clicked()
{
