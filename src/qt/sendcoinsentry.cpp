    ...
    platformStyle(_platformStyle)
{
    ...
    // normal ultracoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying ultracoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &UltracoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
