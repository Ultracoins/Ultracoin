...
#ifndef ULTRACOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define ULTRACOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@ultracoin.
 *
 ...
 *
 * The chacha20-poly1305@ultracoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@ultracoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@ultracoin are relatively fast in
...
#endif // ULTRACOIN_CRYPTO_CHACHA_POLY_AEAD_H
