...
{
    BOOST_CHECK(TestSplitHost("www.ultracoincore.org", "www.ultracoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.ultracoincore.org]", "www.ultracoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.ultracoincore.org:80", "www.ultracoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.ultracoincore.org]:80", "www.ultracoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:42564", "127.0.0.1", 42564));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:42564", "127.0.0.1", 42564));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:42564", "::ffff:127.0.0.1", 42564));
    BOOST_CHECK(TestSplitHost("[::]:42564", "::", 42564));
    BOOST_CHECK(TestSplitHost("::42564", "::42564", -1));
    BOOST_CHECK(TestSplitHost(":42564", "", 42564));
    BOOST_CHECK(TestSplitHost("[]:42564", "", 42564));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:42564", "127.0.0.1:42564"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:42564", "[::]:42564"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
