...
#ifndef ULTRACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define ULTRACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // ULTRACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
