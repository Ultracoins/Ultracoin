...
#ifndef ULTRACOIN_SCRIPT_SCRIPT_H
#define ULTRACOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Ultracoin always counted CHECKMULTISIGs
...
#endif // ULTRACOIN_SCRIPT_SCRIPT_H
