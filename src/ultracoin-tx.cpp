...
static void SetupUltracoinTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ultracoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ultracoin-tx [options] <hex-tx> [commands]  Update hex-encoded ultracoin transaction\n" +
            "or:     ultracoin-tx [options] -create [commands]   Create hex-encoded ultracoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ultracoin transaction
