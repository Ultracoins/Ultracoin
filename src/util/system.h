 ...
 */
#ifndef ULTRACOIN_UTIL_SYSTEM_H
#define ULTRACOIN_UTIL_SYSTEM_H
...
extern const char * const ULTRACOIN_CONF_FILENAME;
extern const char * const ULTRACOIN_SETTINGS_FILENAME;
