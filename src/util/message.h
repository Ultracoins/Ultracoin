...
#ifndef ULTRACOIN_UTIL_MESSAGE_H
#define ULTRACOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's ultracoin address, it must refer to a public key.
...
#endif // ULTRACOIN_UTIL_MESSAGE_H
