...
#ifndef ULTRACOIN_WALLET_WALLET_H
#define ULTRACOIN_WALLET_WALLET_H
...
public:
     ...
     * on this ultracoin node, and set to 0 for transactions that were created
...
#endif // ULTRACOIN_WALLET_WALLET_H
