...
#ifndef ULTRACOIN_WALLET_WALLETUTIL_H
#define ULTRACOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! ultracoin from opening the wallet, thinking it was newly created, and
...
#endif // ULTRACOIN_WALLET_WALLETUTIL_H
