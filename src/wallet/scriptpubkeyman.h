...
#ifndef ULTRACOIN_WALLET_SCRIPTPUBKEYMAN_H
#define ULTRACOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Ultracoin Core wallet was originally a collection of unrelated private
...
#endif // ULTRACOIN_WALLET_SCRIPTPUBKEYMAN_H
