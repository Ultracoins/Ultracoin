...
"""Verify that starting ultracoin with -h works as expected."""

from test_framework.test_framework import UltracoinTestFramework
from test_framework.util import assert_equal

class HelpTest(UltracoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ultracoin with -h for help text")
        ...
        self.log.info("Start ultracoin with -version for version information")
        ...
        self.log.info("Start ultracoind with -fakearg to make sure it does not start")
