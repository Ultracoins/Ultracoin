...
class P2PPermissionsTests(UltracoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].ultracoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].ultracoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
