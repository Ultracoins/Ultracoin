...
By default, ultracoind will dump mempool on shutdown and
...
class MempoolPersistTest(UltracoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent ultracoind from writing mempool.dat to disk. Verify that `savemempool` fails")
