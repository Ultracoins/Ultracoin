...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the UltracoinTestFramework
    pass


class ExampleTest(UltracoinTestFramework):
    # Each functional test is a subclass of the UltracoinTestFramework class.
    ...
    def custom_method(self):
        ...
        UltracoinTestFramework class so other tests can use it."""
