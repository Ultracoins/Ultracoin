...
class TestShell:
    """Wrapper Class for UltracoinTestFramework.

    The TestShell class extends the UltracoinTestFramework
    ...
    class __TestShell(UltracoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by UltracoinTestFramework child class.
            self.num_nodes = 1
