...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the ultracoin repository."
  exit 1
fi
...
# See https://github.com/ultracoin/ultracoin/issues/16064
...
echo 'When compiling ultracoind, run `./configure` in the following way:'
echo
