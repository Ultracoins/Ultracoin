# Bootstrappable Ultracoin Core Builds

This directory contains the files necessary to perform bootstrappable Ultracoin
Core builds.
...
- 24GB of free disk space on the partition that the Ultracoin Core git repository
  resides in
...
For a Ultracoin Core depends development environment, simply invoke
...
From the top of a clean Ultracoin Core repository:
...
To use dongcarl's substitute server for Ultracoin Core builds after having
